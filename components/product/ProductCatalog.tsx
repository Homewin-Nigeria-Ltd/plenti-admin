  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="border border-neutral-100 rounded-[8px] h-[50px] flex items-center gap-1 p-2 px-4 shadow-sm flex-1 max-w-md">
        ...
        <div className="flex items-center gap-2">
          <Button
            className="bg-primary hover:bg-primary/90 h-[50px]"
          ...
          <TabsList className="bg-transparent border-0 p-0 h-auto gap-2">
            {categories.map((category) => (
              <TabsTrigger
                key={category}
                value={category}
                className="data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-sm rounded-md px-4 py-2 text-sm font-medium">
                {category}
              </TabsTrigger>
            ))}
          </TabsList>
