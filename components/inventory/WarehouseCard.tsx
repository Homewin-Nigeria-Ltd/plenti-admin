    ...
    <div className="bg-white rounded-xl border border-[#EAECF0] p-4 sm:p-5 shadow-xs">
      ...
      <div className="mb-2 sm:mb-3">
        <p className="text-[#0B1E66] text-xl sm:text-2xl font-semibold tracking-tight">
          ...
          <span className="text-sm sm:text-base font-normal text-neutral-600 ml-1">
            Units
          </span>
        </p>
      </div>
      <div>
        {warehouse.product_count != null && warehouse.stock_value != null ? (
          <p className="text-neutral-500 text-xs truncate">
            ...
            <span className="text-neutral-700">
              ...
              }).format(Number(warehouse.stock_value))}
            </span>
          </p>
        ) : (
          <p className="text-neutral-500 text-xs truncate">
            Manager:{" "}
            <span className="text-neutral-700">{warehouse.manager}</span>
          </p>
        )}
      </div>
    </div>
