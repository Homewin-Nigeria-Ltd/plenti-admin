          ...
          <div className="flex items-start justify-between mb-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 flex-wrap">
                <span className="px-2 py-0.5 bg-[#FEFEEB] text-[#ADA605] rounded-[16px] text-xs font-medium">
                  {campaign.channel}
                </span>
          ...
          <div className="grid grid-cols-5 gap-4">
            ...
            <div className="bg-green-50 rounded-lg p-4 text-center">
              <span className="text-xl font-bold text-[#0F973D]">
                {formatNumber(campaign.stats.delivered.count)}
              </span>
              <p className="text-sm text-[#98A2B3] mt-1">
                Delivered ({campaign.stats.delivered.percentage}%)
              </p>
            </div>
            ...
            <div className="bg-orange-50 rounded-lg p-4 text-center">
              <span className="text-xl font-bold text-[#F3A218]">
                {formatNumber(campaign.stats.opened.count)}
              </span>
              <p className="text-sm text-[#98A2B3] mt-1">
                Opened ({campaign.stats.opened.percentage}%)
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-4 text-center">
              <span className="text-xl font-bold text-[#0B1E66]">
                {formatNumber(campaign.stats.clicked.count)}
              </span>
              <p className="text-sm text-[#98A2B3] mt-1">
                Clicked ({campaign.stats.clicked.percentage}%)
              </p>
            </div>
