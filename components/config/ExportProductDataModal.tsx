...
type ExportProductDataModalProps = {
  isOpen: boolean;
  onClose: () => void;
  totalRecords?: number;
};

export default function ExportProductDataModal({
  isOpen,
  onClose,
  totalRecords = 5,
}: ExportProductDataModalProps) {
      ...
      >
        <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-4 border-b border-neutral-100 relative">
          ...
          <DialogDescription className="text-sm text-[#667085]">
            Export product records with customizable fields and date filters.
          </DialogDescription>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-[#667085]">Product Category</Label>
