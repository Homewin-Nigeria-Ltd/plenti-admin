...
type ExportOrdersDataModalProps = {
  isOpen: boolean;
  onClose: () => void;
  /** Total records that match current filters (for summary). */
  totalRecords?: number;
};

export default function ExportOrdersDataModal({
  isOpen,
  onClose,
  totalRecords = 5,
}: ExportOrdersDataModalProps) {
  ...
  const handleExport = () => {
    // TODO: call export API with format, date range, filters, selected fields
    onClose();
  };
      ...
      >
        <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-4 border-b border-neutral-100 relative">
          ...
          <DialogDescription className="text-sm text-[#667085]">
            Export order records with customizable fields and date filters.
          </DialogDescription>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <Label className="text-xs text-[#667085]">Order Status</Label>
              ...
              <div className="space-y-1.5">
                <Label className="text-xs text-[#667085]">Payment Method</Label>
